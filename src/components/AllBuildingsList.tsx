...
export default function AllBuildingsList(props: allBuildingsListProps) {
  ...
  const resultBuildings = props.resultBuildingsUnsorted.sort((buildingA: any, buildingB: any) => genericSort<IBuilding>(buildingA, buildingB, activeSorter));

  return (
    <Container fluid>
      <Row>
        <Col sm={12} md={{ span: 9, offset: 1 }} lg={{ span: 8, offset: 0 }} className="p-0">
