      ...
      <Row className="justify-content-center">
        <Col>
          <Row className="align-items-center pb-3">
            ...
            <Col lg={8}>
              <div className="lead">
                ...
                comfortable rent-reduced housing. It aims to supplement existing
                government resources by mapping all buildings that participate
                in the MFTE (Multifamily Tax Exemption) program.
              </div>
            </Col>
          </Row>
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                We chose to highlight the MFTE program because of the relatively
                quick application turnaround, higher availability, and modern
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                Search and filter for apartments that fit your criteria (such as
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                ...
                available to everyone. Please view official government resources
                for complete information on rent-reduced and affordable housing
                programs in Seattle.
              </div>
              <div className="lead">
