      ...
      <Row className="justify-content-center">
        <Col>
          <Row className="align-items-center pb-3">
            ...
            <Col lg={8}>
              <div className="lead">
                The purpose of this website is to help people find safe and comfortable rent-reduced housing. It aims to supplement existing government
                resources by mapping all buildings that participate in the MFTE (Multifamily Tax Exemption) program.
              </div>
            </Col>
          </Row>
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                We chose to highlight the MFTE program because of the relatively quick application turnaround, higher availability, and modern apartments in
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                ...
                . Updated spreadsheets are published by the Seattle Office of Housing roughly twice a year.
              </div>
            </Col>
          </Row>
          ...
          <Row className="align-items-center py-3">
            ...
            <Col lg={8}>
              <div className="lead">
                MFTE is not the only rent-reduced program, and it's not available to everyone. Please view official government resources for complete
                information on rent-reduced and affordable housing programs in Seattle.
              </div>
              <div className="lead">
          ...
          <Row className="align-items-center py-3">
            ...
            <Col>
              <div className="lead">We do not share your information with anyone.</div>
            </Col>
          </Row>
        </Col>
      </Row>
